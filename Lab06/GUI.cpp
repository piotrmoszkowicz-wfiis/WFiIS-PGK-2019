...
MyFrame1::MyFrame1(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size,
    ...
    m_b_grayscale->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MyFrame1::m_b_grayscale_click), NULL,
                           this);
    ...
    m_b_rotate_hue->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MyFrame1::m_b_rotate_hue_click), NULL,
                            this);
    ...
    m_s_brightness->Connect(wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler(MyFrame1::m_s_brightness_scroll), NULL,
                            this);
    ...
    m_b_threshold->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MyFrame1::m_b_threshold_click), NULL,
                           this);
}

MyFrame1::~MyFrame1() {
    // Disconnect Events
    m_scrolledWindow->Disconnect(wxEVT_UPDATE_UI, wxUpdateUIEventHandler(MyFrame1::m_scrolledWindow_update), NULL,
                                 this);
    m_b_grayscale->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MyFrame1::m_b_grayscale_click), NULL,
                              this);
    ...
    m_b_replace->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MyFrame1::m_b_replace_click), NULL,
                            this);
    m_b_rescale->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MyFrame1::m_b_rescale_click), NULL,
                            this);
    m_b_rotate->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MyFrame1::m_b_rotate_click), NULL, this);
    m_b_rotate_hue->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MyFrame1::m_b_rotate_hue_click),
                               NULL, this);
    ...
    m_s_brightness->Disconnect(wxEVT_SCROLL_LINEDOWN, wxScrollEventHandler(MyFrame1::m_s_brightness_scroll), NULL,
                               this);
    m_s_brightness->Disconnect(wxEVT_SCROLL_PAGEUP, wxScrollEventHandler(MyFrame1::m_s_brightness_scroll), NULL, this);
    m_s_brightness->Disconnect(wxEVT_SCROLL_PAGEDOWN, wxScrollEventHandler(MyFrame1::m_s_brightness_scroll), NULL,
                               this);
    m_s_brightness->Disconnect(wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler(MyFrame1::m_s_brightness_scroll), NULL,
                               this);
    m_s_brightness->Disconnect(wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler(MyFrame1::m_s_brightness_scroll), NULL,
                               this);
    ...
    m_s_contrast->Disconnect(wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler(MyFrame1::m_s_contrast_scroll), NULL,
                             this);
    m_s_contrast->Disconnect(wxEVT_SCROLL_CHANGED, wxScrollEventHandler(MyFrame1::m_s_contrast_scroll), NULL, this);
    m_b_prewitt->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MyFrame1::m_b_prewitt_click), NULL,
                            this);
    m_b_threshold->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MyFrame1::m_b_threshold_click), NULL,
                              this);
